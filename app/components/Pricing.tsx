...
<div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
  ...
  {plans.map((plan, i) => (
    ...
    >
      ...
      {/* gradient bar */}
      <div className={`absolute top-0 left-0 w-[80%] ml-[10%] h-1 bg-gradient-to-r ${plan.color}`} />
      ...
      <button className="mt-6 w-full py-3 rounded-xl bg-slate-900 text-white font-medium hover:bg-slate-800 transition">
        არჩევა
      </button>
