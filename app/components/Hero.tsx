    ...
    <section className="relative w-full min-h-screen flex items-center justify-center bg-white z-10">
      ...
      <div className="relative max-w-4xl mx-auto px-6 flex flex-col items-center text-center ">
        ...
        <h1 className="font-bold leading-tight flex flex-col items-center">
          <span className="mt-3 sm:mt-4 animate-fadeUp delay-150">
        ...
        {/* Subtitle */}
        <p className="mt-8 text-slate-600 text-sm max-w-2xl leading-relaxed">
          ANRA Studio ქმნის სწრაფ, თანამედროვე და მომხმარებელზე ორიენტირებულ
          ვებსაიტებს, რომლებიც ზრდის შენს გაყიდვებს და გხდის უფრო ცნობადს.
        </p>
