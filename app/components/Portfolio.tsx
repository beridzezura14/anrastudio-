...
export default function Portfolio() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={trackRef}
        className="flex flex-col lg:flex-row lg:flex-nowrap gap-8 px-6 lg:px-0 items-center lg:items-start will-change-transform lg:w-max justify-center relative z-10"
      >
